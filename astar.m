...
visited_a=[];
cost_arr =inf(floor(250/res),floor(150/res));
cost_arr(1,1)=0;
cost_goarr=zeros(floor(250/res),floor(150/res));
cost_comearr=zeros(floor(250/res),floor(150/res));
parent_arr=cell(floor(250/res),floor(150/res));
q=[];
q=start_node;
z=start_node;
while(isequal(z,endnode)==0)
    ...
    if(status==1)
        ...
        if (value==0)
            ...
            cost_comearr(newnode(1),newnode(2))=cost_comearr(z(1),z(2))+1;
            cost_arr(newnode(1),newnode(2))=cost_comearr(newnode(1),newnode(2))+c;
        else
            if(cost_comearr(newnode(1),newnode(2))>cost_comearr(z(1),z(2))+1)
               [c,cost_goarr]=cost_go(cost_goarr,newnode,endnode);
               cost_comearr(newnode(1),newnode(2))=cost_comearr(z(1),z(2))+1;
               cost_arr(newnode(1),newnode(2))=cost_comearr(newnode(1),newnode(2))+c;
               parent_arr(newnode(1),newnode(2))={[z(1) z(2)]};   
    ...
    if status==1
        ...
        if (value==0)
            ...
            parent_arr(newnode(1),newnode(2))={[z(1) z(2)]};
            [c,cost_goarr]=cost_go(cost_goarr,newnode,endnode);
            cost_comearr(newnode(1),newnode(2))=cost_comearr(z(1),z(2))+sqrt(2);
            cost_arr(newnode(1),newnode(2))=cost_comearr(newnode(1),newnode(2))+c;
             
             
         else
            if(cost_comearr(newnode(1),newnode(2))>cost_comearr(z(1),z(2))+sqrt(2))
                [c,cost_goarr]=cost_go(cost_goarr,newnode,endnode);
                cost_comearr(newnode(1),newnode(2))=cost_comearr(z(1),z(2))+sqrt(2);
                cost_arr(newnode(1),newnode(2))=cost_comearr(newnode(1),newnode(2))+c;
                parent_arr(newnode(1),newnode(2))={[z(1) z(2)]};
